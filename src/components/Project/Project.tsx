      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Shettydishanth" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Edu-Connect</h3>
              <p>
                Developed Edu-Connect, a full-stack app using React, Node.js, and MongoDB to digitize parent-teacher communication, improving efficiency and engagement.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Chronic Disease Prediction |</h3>
              <p>Built a React-based web app that predicts chronic diseases using Random Forest and SVM, delivering real-time results with accuracy scores through efficient health data processing. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Python</li> <li> React</li>  </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Shettydishanth/Blog-App" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
            ...
            <div className="body">
              <h3>BLOG APP</h3>
              <p>
               Developed a full-stack Blog App using the MERN stack, enabling efficient post creation, interaction, and discovery with a responsive and user-friendly interface.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Shettydishanth/tic-tac-toe" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Tic tac toe</h3>
             <p> Built a browser based Tic Tac Toe game using HTML, CSS, and JavaScript for interactive two-player gameplay.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>HTML</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Shettydishanth/strong-password" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              ...
              <p>Developed a C++ program to generate strong and secure passwords automatically using customizable criteria. </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>cpp</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Shettydishanth/internportfolio" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
             Created my first personal portfolio website using React.js, showcasing projects and skills in a clean, responsive design.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
